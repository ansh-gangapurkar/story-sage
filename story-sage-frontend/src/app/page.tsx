    ...
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
          ...
          >
            <p className="subtitle-text max-w-3xl mx-auto -mt-4">  {/* Added -mt-4 to move up */}
              Make Your Story Come to Life
            </p>
            
            {/* Nature-inspired decorative element */}
            <div className="my-8 flex justify-center"> {/* Changed from my-12 to my-8 to reduce spacing */}
            ...
            <motion.div
              ...
              className="mt-6" // Changed from mt-8 to mt-6 to reduce spacing
            >
...
const features = [
  {
    ...
    description: "Transform your text into lifelike audio with Cartesia AI voice technology."
  },
  {
    title: "Natural Voice",
